...
values
    ...
    (newid(),    3, 'Top Wall (Left)',       1600,    300, 3200, 600,  0, 19200000,  0, 0,                  1000, 1000),
    (newid(),    3, 'Door',                 3800,    300, 1200, 100,  0, 30000,     0, 0,                  1000, 1000),
    (newid(),    3, 'Top Wall (Right)',      6800,    300, 4800, 600,  0, 28800000,  0, 0,                  1000, 1000),
    -- left wall, split by one window near the bottom
    (newid(),    3, 'Left Wall (Upper)',      300,   4400, 600,  7600, 0, 45600000,  0, 0,                  1000, 1000),
    (newid(),    3, 'Left Window',            300,   8600, 100,  800,  0, 5000,      1, 0,                  1000, 1000),
    (newid(),    3, 'Left Wall (Lower)',      300,   9800, 600,  1600, 0, 9600000,   0, 0,                  1000, 1000),
    -- right wall, split by two windows
    (newid(),    3, 'Right Wall (Upper)',    8900,   2400, 600,  3600, 0, 21600000,  0, 0,                  1000, 1000),
    (newid(),    3, 'Right Window (Upper)', 8900,   4600, 100,  800,  0, 5000,      1, 0,                  1000, 1000),
    (newid(),    3, 'Right Wall (Middle)',   8900,   7000, 600,  4000, 0, 24000000,  0, 0,                  1000, 1000),
    (newid(),    3, 'Right Window (Lower)', 8900,   9400, 100,  800,  0, 5000,      1, 0,                  1000, 1000),
    (newid(),    3, 'Right Wall (Lower)',    8900,  10200, 600,  800,  0, 4800000,   0, 0,                  1000, 1000),
    -- bottom wall
    (newid(),    3, 'Bottom Wall',          4600,  10900, 9200, 600,  0, 55200000,  0, 0,                  1000, 1000),
