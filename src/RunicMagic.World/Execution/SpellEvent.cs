...
public record EntityDamagedEvent(Entity Entity, long Amount) : SpellEvent;
public record PowerFilledEvent(Entity Entity, long Amount) : SpellEvent;
public record EntityFullEvent(Entity Entity) : SpellEvent;
public record EffectNotFiredEvent(string Effect, string Reason) : SpellEvent;
public record EntityDisintegratedEvent(Entity Entity) : SpellEvent;
