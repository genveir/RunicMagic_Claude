...
{
    internal class CJARParser : IRuneParser<IStatement>
    {
        public ParsingResult<IStatement> Parse(TokenStream tokenStream)
        {
            ...
            return ParsingResult<IStatement>.Succeed(new CJAR(toRotate: toRotateResult.Value, howMuch: howMuchResult.Value, origin: originResult.Value));
        }
    }
}
