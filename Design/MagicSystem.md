...
- **Property filters** — `ZYIL(weight range)`, `ZYHE(lightest)`, and `ZYSE(heaviest)` filter a Set by entity weight. Union, intersection, and difference remain future rune primitives.
